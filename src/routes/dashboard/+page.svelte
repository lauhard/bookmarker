...
<section class="section-base sm:p-5 p-2 pt-5">
    <h1
        class="text-xl sm:text-2xl font-semibold tracking-tight text-center sm:text-left text-primary text-pretty uppercase sm:mb-2 mb-2"
    >
        Dashboard
    </h1>
    <p
        class="text-sm sm:text-base text-center sm:text-left text-base-content/70 mb-5"
    >
    ...
    <div class="collapse collapse-arrow bg-base-100 mb-4">
        ...
        <div
            class="collapse-title font-semibold flex text-base-content/70 items-center gap-2"
        >
            <svg
                ...
                /><path d="M16 2v20" /></svg
            >
            <h2 class="text-lg">Manage Collections</h2>
        </div>
    ...
    <div class="collapse collapse-arrow bg-base-100">
        ...
        <div
            class="collapse-title font-semibold flex items-center text-base-content/70 gap-2"
        >
            <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                /></svg
            >
            <h2 class="text-lg">Manage Favourites</h2>
        </div>
        <div class="collapse-content text-sm shadow-2xl px-0">
